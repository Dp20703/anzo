...
const Page1 = () => {
    return (
        <div className='h-screen bg-white py-4 px-4'>
            ...
            <img className='h-24 ml-10' src="https://static.wixstatic.com/media/f1c650_35a00b1fe6ce403eb237970ec8d34f79~mv2.png/v1/fill/w_99,h_99,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/Frame%2053.png" alt="" />
            <TiltText />
            <Page1Bottom/>
        </div>
        </div>
